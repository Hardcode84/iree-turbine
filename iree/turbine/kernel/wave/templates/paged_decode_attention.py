...
def get_paged_decode_attention_kernels(
    ...
    def phase_1_constraints() -> list[tkw.Constraint]:
        ...
        if phase_1_distribute_query_heads:
            ...
            waves_per_block = (PHASE_1_BLOCK_B_WAVES, PHASE_1_BLOCK_N_WAVES, 1)
        else:
            constraints += [tkw.WorkgroupConstraint(B, BLOCK_B, 1)]
            constraints += [tkw.WorkgroupConstraint(N, BLOCK_N, 0)]
            waves_per_block = (PHASE_1_BLOCK_N_WAVES, PHASE_1_BLOCK_B_WAVES, 1)
    ...
    def phase_1(
        ...
        def repeat(
            ...
            x_j = tkw.read(logits, bounds={U: math.inf}, mapping=logits_in_mapping)
